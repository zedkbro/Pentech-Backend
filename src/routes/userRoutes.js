...
router.post("/contact-us", contactUs.create.bind(contactUs))
      .post("/applications/:careerId",
        uploadFile.fields([
          { name: "cv", maxCount: 1 },
...
router.get("/home", home.getAll.bind(home))
...
router.patch("/contact-us/backup/:id", contactUs.backupFromTrash.bind(contactUs));

router.post("/partners", uploadImage.single("logo"), partner.create.bind(partner))
...
router.delete("/applications/destroy/:id", application.deleteById.bind(application));
router.patch("/applications/backup/:id", application.backupFromTrash.bind(application));
...
router.delete("/subscribers/destroy/:id", subscriber.deleteById.bind(subscriber));
router.patch("/subscribers/backup/:id", subscriber.backupFromTrash.bind(subscriber));
