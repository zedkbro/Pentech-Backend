...
router.get("/services", service.findAll.bind(service))
...
router.get("/service/:title", service.findServiceByTitle)
...
router.patch("/edit-profile", uploadImage.single("avatar"), adminController.editAdminProfilePhoto)
...
router.delete("/profile/destroy/:id", adminController.deleteById.bind(adminController));
router.patch("/profile/backup/:id",adminController.backupFromTrash.bind(adminController));

router.route("/services")
      .post(service.create.bind(service));
...
router.route("/sub-services/:id")
      .post(uploadImage.single("subServiceImage"), subService.create.bind(subService))
      .get(subService.getById.bind(subService))
      .patch(uploadImage.single("subServiceImage"), subService.updateById.bind(subService))
...
router.delete("/testimonials/destroy/:id", testimonial.deleteById.bind(testimonial));
router.patch("/testimonials/backup/:id", testimonial.backupFromTrash.bind(testimonial));
...
router.route("/professionals/:id")
      ...
      .patch(uploadImage.single("avatar"), professionals.updateById.bind(professionals))
      .delete(professionals.moveToTrash.bind(professionals));
router.delete("/professionals/destroy/:id", professionals.deleteById.bind(professionals));
router.patch("/professionals/backup/:id", professionals.backupFromTrash.bind(professionals));
...
router.route("/organizations/:id")
      ...
      .patch(uploadImage.single("image"), organization.updateById.bind(organization))
      .delete(organization.moveToTrash.bind(organization));
router.delete("/organizations/destroy/:id", organization.deleteById.bind(organization));
router.patch("/organizations/backup/:id", organization.backupFromTrash.bind(organization));
...
router.delete("/social-medias/destroy/:id", socialMedia.deleteById.bind(socialMedia));
router.patch("/social-medias/backup/:id",socialMedia.backupFromTrash.bind(socialMedia));

router.route("/contact-address")
      .post(contactAddress.create.bind(contactAddress))
      .delete(contactAddress.deleteAll.bind(contactAddress));
router.route("/contact-address/:id")
...
router.delete("/contact-address/destroy/:id",contactAddress.deleteById.bind(contactAddress));
router.patch("/contact-address/backup/:id",contactAddress.backupFromTrash.bind(contactAddress));
...
router.delete("/privacy-policy/destroy/:id", privacyPolicy.deleteById.bind(privacyPolicy));
router.patch("/privacy-policy/backup/:id", privacyPolicy.backupFromTrash.bind(privacyPolicy));

router.post("/loan-calculator", loanCalculator.create.bind(loanCalculator));
router.route("/loan-calculator/:id")
...
router.delete("/loan-calculator/destroy/:id", loanCalculator.deleteById.bind(loanCalculator));
router.patch("/loan-calculator/backup/:id", loanCalculator.backupFromTrash.bind(loanCalculator));
...
router.delete("/statistics/destroy/:id", statistics.deleteById.bind(statistics));
router.patch("/statistics/backup/:id", statistics.backupFromTrash.bind(statistics));

router.post("/terms-and-conditions", termsAndConditions.create.bind(termsAndConditions));
router.route("/terms-and-conditions/:id")
...
router.delete("/terms-and-conditions/destroy/:id", termsAndConditions.deleteById.bind(termsAndConditions));
router.patch("/terms-and-conditions/backup/:id", termsAndConditions.backupFromTrash.bind(termsAndConditions));

router.post("/why-choose", whyChoose.create.bind(whyChoose));
router.route("/why-choose/:id")
