...
const validator = Joi.object({
  ...
  role: Joi.string().trim().valid("admin", "staff", "shareholder").required().messages({
    "any.required": "Role is required",
    "string.base": "Role must be a string",
    "any.only": "Role must be either admin, staff, or shareholder",
    "string.valid": "Role must be either admin, staff, or shareholder",
  }),
