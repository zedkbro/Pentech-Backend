...
/* ------Validation For Core Values  -----*/
const coreValuesSchema = Joi.object({
...
const validateCoreValues = (core_value) => {
  return coreValuesSchema.validate(core_value, { abortEarly: false });
};
