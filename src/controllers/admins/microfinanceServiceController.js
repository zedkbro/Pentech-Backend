...
import { MicrofinanceService, Sector } from '../../models/admins/Associations.js';
import AdminService from '../../services/adminService.js';

const service = new AdminService(MicrofinanceService);

class MicrofinanceServiceController extends SuperController {
  constructor(service) {
    super(service);
  ...
  create(req, res) {
    try{
      const { error, value } = validator.validateMicrofinanceService(req.body);
      if(error){
...
export default new MicrofinanceServiceController(service);
