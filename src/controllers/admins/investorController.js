...
import Investor from '../../models/admins/Investor.js';
import AdminService from '../../services/adminService.js';

const service = new AdminService(Investor);

class InvestorController extends SuperController {
  constructor(service) {
    super(service);
...
export default new InvestorController(service);
