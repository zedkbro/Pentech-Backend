...
import Professional from '../../models/admins/Professional.js';
import AdminService from '../../services/adminService.js';

const service = new AdminService(Professional);

class ProfessionalController extends SuperController {
  constructor(service) {
    super(service);
  ...
  create(req, res) {
    ...
    try{
      const { error, value } = validator.validateProfessionals(req.body);
      if(error){
...
export default new ProfessionalController(service);
